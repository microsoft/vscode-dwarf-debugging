...
//
// Vendored from devtools-frontend extensions/cxx_debugging/src/WorkerRPC.ts so
// the native symbolizer path (src/index.ts) can build without the
// Docker/emscripten output in chrome-cxx/mnt. Only the import paths were
// adjusted to the sibling vendored modules; the runtime behaviour is identical.
// See src/vendor/README.md.

import type {Chrome} from './extension-api';
import type {ModuleConfigurations} from './ModuleConfiguration';
